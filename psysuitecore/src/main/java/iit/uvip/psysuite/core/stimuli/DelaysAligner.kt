...
import iit.uvip.psysuite.core.utility.StimuliDelay
...
class DelaysAligner(val a1:Long=0L, val a2:Long=0L, val a3:Long=0L, val t1:Long=0L, val t2:Long=0L, val v1:Long=0L, val v2:Long=0L) : Parcelable {
    ...
    StimuliManager.STIM_TYPE_V2 to StimuliDelay(-1, -1, v2),

    StimuliManager.STIM_TYPE_A1T1 to StimuliDelay(a1, t1, -1),
    StimuliManager.STIM_TYPE_A1T2 to StimuliDelay(a1, t2, -1),
    StimuliManager.STIM_TYPE_A1V1 to StimuliDelay(a1, -1, v1),
    StimuliManager.STIM_TYPE_A1V2 to StimuliDelay(a1, -1, v2),
    StimuliManager.STIM_TYPE_A2T1 to StimuliDelay(a2, t1, -1),
    StimuliManager.STIM_TYPE_A2T2 to StimuliDelay(a2, t2, -1),
    StimuliManager.STIM_TYPE_A2V1 to StimuliDelay(a2, -1, v1),
    StimuliManager.STIM_TYPE_A2V2 to StimuliDelay(a2, -1, v2),
    StimuliManager.STIM_TYPE_A3T1 to StimuliDelay(a3, t1, -1),
    ...
    StimuliManager.STIM_TYPE_T2V2 to StimuliDelay(-1, t2, v2),

    StimuliManager.STIM_TYPE_A1T1V1 to StimuliDelay(a1, t1, v1),
    StimuliManager.STIM_TYPE_A1T2V1 to StimuliDelay(a1, t2, v1),
    StimuliManager.STIM_TYPE_A1T1V2 to StimuliDelay(a1, t1, v2),
    StimuliManager.STIM_TYPE_A1T2V2 to StimuliDelay(a1, t2, v2),
    StimuliManager.STIM_TYPE_A2T1V1 to StimuliDelay(a2, t1, v1),
    StimuliManager.STIM_TYPE_A2T2V1 to StimuliDelay(a2, t2, v1),
    StimuliManager.STIM_TYPE_A2T1V2 to StimuliDelay(a2, t1, v2),
    StimuliManager.STIM_TYPE_A2T2V2 to StimuliDelay(a2, t2, v2),
    ...
    fun arrangeDelays(type:Int=0, a:Long, t:Long, v:Long): CorrectedStimuliDelay {
        ...
        val types = StimuliManager.maintype2unimodaltypes(type)  // set -1 if modality is not in the type
        val atype = types[0]
        val ttype = types[1]
        val vtype = types[2]
