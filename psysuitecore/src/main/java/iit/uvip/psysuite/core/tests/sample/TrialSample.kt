...
class TrialSample(id:Int=-1, type:Int, label:String, val position:Int, val conflict_type:String, val duration:Int, private val duration2:Int=0): TrialBasic(id,type,label, ""){
