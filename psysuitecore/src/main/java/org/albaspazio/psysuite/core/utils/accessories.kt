package org.albaspazio.psysuite.core.utils
...
import org.albaspazio.psysuite.tests.TestBasic.Companion.CONFLICT_TYPE_NONE
...
data class StimuliSet(val ntrials:Int, val magnitude:Float)
data class StimuliSetBIS(val ntrials:Int, val magnitude:Float, var conflict:String = CONFLICT_TYPE_NONE)
