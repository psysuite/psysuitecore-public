package org.albaspazio.psysuite.ui.fragments
...
class TestFragment : BaseFragment(
    ...
    // - (try) instantiate the correct TestClass
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        speechManager = SpeechManager(requireContext()) {
            ...
            val answerDialogClass = if (isBlindUser) {
                                        ...
                                        "org.albaspazio.psysuite.ui.fragments.answers.AnswerGestureDialogFragment"
                                    }
                                    else {
                                        if (mSubjectParcel.classes.size > 1 && mSubjectParcel.classes[1].isNotEmpty())
                                            mSubjectParcel.classes[1]
                                        else "org.albaspazio.psysuite.ui.fragments.answers.TwoAFCAnswerDialogFragment"
                                    }
